...
--		fpga_0	: out std_logic_vector(7 downto 0);
--		fpga_1	: out std_logic_vector(7 downto 0);
--		fpga_2	: out std_logic_vector(7 downto 0);
--		fpga_3	: out std_logic_vector(7 downto 0);
--		fpga_4	: out std_logic_vector(7 downto 0);
--		fpga_5	: out std_logic_vector(7 downto 0);
--		fpga_6	: out std_logic_vector(7 downto 0);
--		fpga_7	: out std_logic_vector(7 downto 0);
--		fpga_8	: out std_logic_vector(7 downto 0);
...
signal 	fpga_out  	: std_logic_vector(WORD_SIZE-1 downto 0);
...
--=======================================================================		
mem:  mips_mem
		port map (address => memadd_v(7 downto 0), byteena => byte_clt_out_v, data => write_data, wren => mem_wr_s, clk => clk_rom, Q => memout_v );
...
--=======================================================================
-- Mux para selecao da entrada de cima da ula shift ou regist
--=======================================================================		
...
--=======================================================================
-- Mux para seleção da operação de load
--=======================================================================
mux_mdr: mux_3
	port map(
		in0		=> memout_v,
